# STM32U5 Device-Specfic USB Power Delivery Middleware Library MCU Software Component
...
This repository provides the STM32Cube **device-specific** Middleware Library of the **STM32CubeU5** MCU firmware for managing the **USB Type-C** physical layer.
