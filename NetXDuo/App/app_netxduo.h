...
#undef  TOPIC_NAME
#define TOPIC_NAME                  "home/server/wol_command"

#undef  MQTT_BROKER_NAME
...
/* Zwiększamy bufory, żeby zmieścił się długi topik i wiadomość */
...
#define CLIENT_ID_STRING            "YOUR_UNIQUE_CLIENT_ID" // Replace with a unique identifier
